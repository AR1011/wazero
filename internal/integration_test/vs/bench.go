...
//
//	-ldflags '-X github.com/AR1011/wazero/internal/integration_test/vs.ensureCompilerFastest=true'
...
// This is disabled by default, and can be run with -ldflags '-X github.com/AR1011/wazero/vs.ensureCompilerFastest=true'.
